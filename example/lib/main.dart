...
class FirstPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () => _pushSecondPage(context),
  ...
  Future<void> _pushSecondPage(BuildContext context) {
    return switch (NavigationMode.current) {
...
class _SecondPageState extends State<SecondPage> {
      ...
      body: SizedBox.expand(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => _pushThirdPage(context),
  ...
  Future<void> _pushThirdPage(BuildContext context) {
    return switch (NavigationMode.current) {
      NavigationMode.navigator => Navigator.of(
        context,
